...
<body background="style/indexxx.png" style='font-family:Righteous'>
  <header>
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb shadow-lg p-3 mb-5 bg-light rounded">
        ...
        <li class="breadcrumb-item"><a href="pages/contactOf.php">Nous contacter</a></li>
  ...
  <center>
  <div class="container">
  <button type="button" style="box-shadow: 0 3px 9px black" class="btn btn-danger btn-lg" data-toggle="modal" data-target="#myModal">Cliquez ici !</button>
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">

        <center>Petit conseil 🙂</center>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        <div class="modal-body">
        <p> Nous vous invitons fortement à vous créer un compte afin de profiter pleinement des fonctionnalités que propose notre site</p>
        </div>
...
<center>
        ...
        <div class="card border-dark" style="width:15rem">
          <div class="solid">
            ...
            <div class="card-body ">
             ...
             <p> <center><a class="btn btn-sm btn-info" role="button">Connectez-vous pour laisser un commentaire.</a></center></p>
            </div>
  ...
  for ($i = 1; $i <= $pagesTotales; $i++) {
    if ($i == $pageCourante) {
      ...
      echo '<li class="page-item "><a class="page-link " <a href="index.php?page=' . $i . '">' . $i . '</a> ';
    }
  }
  ?>
