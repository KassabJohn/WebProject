            ...
            if(isset($_POST['valider'])){
                if(!isset($_POST['pseudo'],$_POST['mdp'])){
                    ...
                    if(!$mysqli) {
                        ...
                        $req=mysqli_query($mysqli,"SELECT * FROM adminn WHERE pseudo='$Pseudo' AND mdp='$Mdp'");
                        if(mysqli_num_rows($req)!=1){
                            ...
                            echo "<br> Vous êtes connecté en mode admin !<br><br>";
                            echo "<button type='button' class='btn btn-secondary btn-sm'><a href='index2.php'>Retour à l'accueil</a></button>  ";
